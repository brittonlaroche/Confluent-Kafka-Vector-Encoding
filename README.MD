...
You will need to adjust a couple of settings to get the data to disply properly in the cloud gui.  Go to the Connector and under advanced settings the following:   
