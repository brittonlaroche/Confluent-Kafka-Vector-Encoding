...
If you can't tell I speak from experience using opensource databases.  One fine morning I recieved a four AM phone call on a Saturday morning. I was awake with a full on migrane headache. After I fixed the problem, I was done with opensource forever.  Some opensource databases used to use a default storage system of 4GB.  If you are a datasbse guy and you have been around you probably know exactly what I am taking about.  First thing on the list was moving that data to a heavy weight vendor database with 24 hour support.   
