...
Pick a modern cloud native database that is adding the vector search capability. Go modern, go with cloud native. Trust me: go NoSQL over relational. Go transactional over data warehouse.  Why?  Many modern NoSQL databases are hyper scalable and near real-time. [They are webscale ... this video is an inside joke for employees at MongoDB, we had stickers and T-Shirts based on this video](https://youtu.be/b2F-DItXtZs) That is why I have my top 3 listed above.
